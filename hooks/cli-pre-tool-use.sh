#!/bin/bash
# CLI Hook: Pre Tool Use
# Receives full JSON on stdin from Kiro CLI with tool_name, tool_input
set -euo pipefail
...
# Read the full JSON from stdin (Kiro CLI sends tool_name + tool_input)
INPUT=$(cat)
